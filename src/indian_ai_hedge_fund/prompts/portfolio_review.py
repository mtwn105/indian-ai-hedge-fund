...
# Added: Synthesis-specific instructions to append to SYSTEM_PROMPT
...
Highlight key strengths, weaknesses, potential risks, and opportunities suggested by the data and analyst insights.
